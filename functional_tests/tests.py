...
class NewVisitorTest(LiveServerTestCase):
    ...
    def wait_for_rows_in_list_table(self, row_text):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        self.wait_for_rows_in_list_table('1: Buy peacock feathers')
        self.wait_for_rows_in_list_table('2: Use peacock feathers to make a fly')

        # Satisfied, she goes back to sleep

    def test_multiple_users_can_start_lists_at_different_urls(self):
        # Edith starts sa new to-do list
        self.browser.get(self.live_server_url)
        inputbox = self.browser.find_element_by_id('id_new_item')
        inputbox.send_keys('Buy peacock feathers')
        inputbox.send_keys(Keys.ENTER)
        ...
        # intresting that Edith...
        inputbox = self.browser.find_element_by_id('id_new_item')
        inputbox.send_keys('Buy milk')
        inputbox.send_keys(Keys.ENTER)
        self.wait_for_rows_in_list_table('1: Buy milk')

        # Fancies gets his own unique URL
